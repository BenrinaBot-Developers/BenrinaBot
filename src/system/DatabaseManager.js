...
class Cache {
  ...
  #getPath(_selecter) {
    return `${__dirname}/../database/cache/L${this.level}/${_selecter}/${this.type}.json`;
  }
...
client.on("ready", async () => {
  ...
  cacheManager_test1.get("aaa")
    .then(console.log);
  cacheManager_test1.get("aaa", "test")
    .then(console.log);
  await cacheManager_test1.put({aaa:54321, bbb:"abc", ccc:"xyz1234"})
  cacheManager_test1.get("test", "aaa", "test2", "test", "bbb", "ccc")
    .then(console.log);
